                    ...
                    {projects.map((project, i) => (
                        <MagneticElement key={i} strength={0.2}>
                            <motion.div
                                ...
                                className="group bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:border-purple-400/50 transition-all duration-500 shadow-xl h-full"
                            >
